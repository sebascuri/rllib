...
from exps.gpucrl.reacher_sparse import TRAIN_EPISODES, ENVIRONMENT_MAX_STEPS, \
    ACTION_COST, \
...
environment.env.action_scale = 1.
agent.reward_model.action_scale = 1.
environment.env.length_scale = .3
agent.reward_model.length_scale = .3
