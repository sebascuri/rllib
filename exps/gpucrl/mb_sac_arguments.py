...
model_parser.add_argument("--model-layers", type=int, nargs="*", default=[256, 256])
...
policy_parser.add_argument("--policy-layers", type=int, nargs="*", default=[256, 256])
policy_parser.add_argument("--policy-non-linearity", type=str, default="Tanh")
...
value_function_parser.add_argument(
    "--q-function-layers", type=int, nargs="*", default=[256, 256]
)
value_function_parser.add_argument(
    "--q-function-non-linearity", type=str, default="Tanh"
)
...
sac_parser.add_argument("--sac-target-update-frequency", type=int, default=1)
sac_parser.add_argument("--sac-batch-size", type=int, default=100)
sac_parser.add_argument("--sac-opt-lr", type=float, default=1e-3)
sac_parser.add_argument("--sac-opt-weight-decay", type=float, default=0)
sac_parser.add_argument("--sac-eta", type=float, default=0.2)
sac_parser.add_argument("--sac-regularization", action="store_false", default=False)
sac_parser.add_argument("--sac-target-num-steps", type=int, default=1)
sac_parser.add_argument("--sac-num-samples", type=int, default=15)
...
sim_parser.add_argument("--sim-memory-num-trajectories", type=int, default=0)
sim_parser.add_argument("--sim-max-memory", type=int, default=10000)
