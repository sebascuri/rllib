...
parser.add_argument('--environment-max-steps', type=int, default=400)
...
parser.add_argument('--plan-samples', type=int, default=8)
...
parser.add_argument('--model-opt-lr', type=float, default=5e-4)
...
environment = GymEnvironment('Acrobot-v2', hparams['seed'])
