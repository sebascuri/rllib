...
class MBMPPOAgent(ModelBasedAgent):
    ...
    def __init__(self,
        ...
        super().__init__(
            ...
            sim_num_steps=num_simulation_steps,
            sim_initial_states_num_trajectories=num_simulation_trajectories,
            sim_initial_dist_num_trajectories=num_distribution_trajectories,
            sim_memory_num_trajectories=num_dataset_trajectories,
            sim_refresh_interval=1,
            sim_num_subsample=num_subsample,
