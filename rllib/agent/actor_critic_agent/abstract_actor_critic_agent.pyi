...
class AbstractPolicyGradient(AbstractAgent):
    ...
    baseline_target: AbstractValueFunction
    ...
    def _train_actor(self, observations: List[Observation]) -> None: ...

    def _train_baseline(self, observations: List[Observation]) -> None: ...
