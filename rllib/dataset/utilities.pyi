...
def _observation_to_num_steps(
    observation: Observation, num_steps: int, repeat: bool = ...
) -> Observation: ...
def observation_to_num_steps(
    observation: Observation, num_steps: int, repeat: bool = ...
) -> Observation: ...
def trajectory_to_num_steps(
    trajectory: Trajectory, num_steps: int, repeat: bool = ...
) -> Trajectory: ...
