...
class TransformedModel(AbstractModel):
    ...
    def transform_inputs(self, state: Tensor, action: Tensor, next_state: Optional[Tensor] = ...
                         ) -> Observation: ...
    def back_transform_predictions(self, obs: Observation, next_state: Tensor, reward: Tensor,
                                   done: Tensor) -> Observation: ...
    def predict(
