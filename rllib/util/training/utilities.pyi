...
def calibration_score(
    model: AbstractModel, observation: Observation, bins: int = ..., dynamical_model: Optional[AbstractModel]=...
) -> Tensor: ...
def sharpness(model: AbstractModel, observation: Observation, dynamical_model: Optional[AbstractModel]=...) -> Tensor: ...
def model_mse(model: AbstractModel, observation: Observation, dynamical_model: Optional[AbstractModel]=...) -> Tensor: ...
def model_loss(model: AbstractModel, observation: Observation, dynamical_model: Optional[AbstractModel]=...) -> Tensor: ...
